...
[pscustomobject]@{
    ...
    bridge_build_id_expected = 'synapse-chrome-bridge-2026-06-17-set-field-value-v1'
    bridge_build_sha256_expected = 'aa134c36b51b7a02ebcf4c94523e8034c85aa958776aa12e7815edd7d5e68540'
    bridge_required_capabilities = @('closeTab', 'navigateTab', 'openTab', 'reloadSelf', 'targetInfo', 'targetInfoPageText', 'typeActiveElement', 'setFieldValue')
