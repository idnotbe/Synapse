...
[pscustomobject]@{
    ...
    bridge_build_id_expected = 'synapse-chrome-bridge-2026-06-16-activate-tab-1189-v1'
    bridge_build_sha256_expected = '4a5c0307cda4d2812e054977fc703c558ebc27c2d31c99cb1bcfbbe788a026da'
