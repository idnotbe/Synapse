...
[pscustomobject]@{
    ...
    bridge_build_id_expected = 'synapse-chrome-bridge-2026-06-22-assert-aria-v1'
    bridge_build_sha256_expected = '9345734813fc6868554aac23cf5aa05b800edb983982bcc2fc782e8082704f27'
