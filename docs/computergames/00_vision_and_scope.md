...
| Tool-bloat (200+ MCP tools, agent confused) | Hard cap: current approved live surface is 52 tools after M4/M5 registry/audit expansion, #462 profile-authoring candidate tools, #468 registry/audit inspector, and #499 profile-keymap action aliases. Anything else is a profile, a parameter, or a sub-command of an existing tool unless an ADR approves the cap change |
